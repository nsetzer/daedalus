...
class TransformExtractStyleSheet(TransformBase):
    ...
    def _extract(self, token, parent):
        ...
        if len(arglist.children) == 1:
            arg0 = arglist.children[0] # style dictionary
            ...
            # style sheet with selector
            arg0 = arglist.children[0] # selector
            arg1 = arglist.children[1] # style dictionary
...
def main_unpack(): # pragma: no cover
    from .parser import Parser
    from .formatter import Formatter
    text = """
