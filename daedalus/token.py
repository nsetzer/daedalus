...
class Token(object):
    ...
    T_PUBLIC_STATIC_PROPERTY = "T_PUBLIC_STATIC_PROPERTY"
    T_PRIVATE_STATIC_PROPERTY = "T_PRIVATE_STATIC_PROPERTY"
    T_PUBLIC_PROPERTY = "T_PUBLIC_PROPERTY"
    T_PRIVATE_PROPERTY = "T_PRIVATE_PROPERTY"
    T_YIELD = "T_YIELD"
